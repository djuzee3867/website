...
const socialLinks = [
  {
    name: "Email",
    displayName: "Email",
    subText: "natchaphol.3867@gmail.com",
    icon: Mail,
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@djuzee_",
    icon: Instagram,
    url: "https://www.instagram.com/djuzee_",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "Natchaphol Klewklom ",
    icon: Facebook,
    url: "https://www.facebook.com/djuzeeremix/",
    color: "#0400ff",
    gradient: "from-[#006eff] to-[#0011ff]"
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@djuzee3867",
    icon: Github,
    url: "https://github.com/djuzee3867",
    color: "#ffffff",
  ...
  },
  {
    ...
    subText: "@djuzee_",
    icon: ExternalLink,
    url: "https://www.linkedin.com/in/natchaphol-klewklom-025686277?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    color: "black",
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        <a  onClick={() => window.location.href = "natchaphol.3867@gmail.com"}
  href={linkedIn.url}
  target="_blank"
